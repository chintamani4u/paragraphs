  ...
  Drupal.Leaflet.prototype.add_features = function (features, initial) {
    ...
    for (var i = 0; i < features.length; i++) {
      ...
      // START OF MODIFICATIONS ----.
        ...
        // If the type is not undefined, it's a single feature.
        // Reason: BC
        if (typeof feature.type !== 'undefined') {
          ...
          // If we have multiple features, we need to add them one by one.
          // @note: This is the main change from the original Leaflet implementation.
